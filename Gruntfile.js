...
/*
 * Provides tasks for building and testing the "asteria-cronos" project.
 */
module.exports = function(grunt) {
  ...
  //--> Task: builds the "asteria-cronos" project:
  grunt.registerTask('build', ['ts:build', 'copy:main',
                               'copy:initTypes', 'copy:buildTypesFile',
                               'clean:build']);

  //--> Task: builds the "asteria-cronos" API documentation:
